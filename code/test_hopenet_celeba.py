...
if __name__ == '__main__':
    ...
    data_list = []
    print('start')
    for i, (images, names, pitch, yaw) in tqdm(enumerate(test_loader)):
        ...
        data_list.append([names[0], yaw[0], yaw_predicted[0].item(), pitch[0], pitch_predicted[0].item(), roll_predicted[0].item()])
